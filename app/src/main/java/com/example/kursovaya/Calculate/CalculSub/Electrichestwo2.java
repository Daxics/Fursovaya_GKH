...
public class Electrichestwo2 extends AppCompatActivity implements View.OnClickListener {
    EditText Day, Night;
    Button CalcBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electrichestwo2);
        init();
    }
    ...
    public void onClick(View view) {
        if (Day.getText().length() != 0 || Night.getText().length() != 0) {
            ...
            double electr_day = Double.parseDouble(electr.getString("electricity_duo_1", "1"));
            double electr_night = Double.parseDouble(electr.getString("electricity_duo_2", "1"));

            SharedPreferences.Editor editor = elect_pref.edit();
            editor.putString("saved_elect", String.valueOf(electr_day *
